...
export function ExtractionButton({ selectedCount, isExtracting, isSuccess, onExtract }: ExtractionButtonProps) {
		...
		>
			{isExtracting ? (
				...
				<>
					...
					<span>
						Copy {selectedCount} {selectedCount === 1 ? "Item" : "Items"} as JSON
					</span>
				</>
			)}
		</button>
